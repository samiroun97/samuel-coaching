      ...
      <div className="flex flex-col gap-2">
        {catalogue.length > 0 && (
          <button type="button" onClick={() => setShowLibraryBrowser(true)}
            ...
            <span className="shrink-0 w-[4.5rem] h-[4.5rem] flex items-center justify-center">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/icons/library.svg" alt="" width={72} height={72} className="w-full h-full object-contain"/>
            </span>
        ...
        <button type="button" onClick={add}
          ...
          <span className="shrink-0 w-[4.5rem] h-[4.5rem] flex items-center justify-center">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="/icons/entrainement-libre.svg" alt="" width={72} height={72} className="w-full h-full object-contain"/>
          </span>
          <span className="flex-1 text-left">
