    ...
    <div className="flex flex-col gap-3">
      {catalogue.length > 0 && (
        <button type="button" onClick={() => setShowLibraryBrowser(true)}
          ...
          <span className="shrink-0 w-[4.5rem] h-[4.5rem] rounded-2xl bg-[#c9a84c]/10 flex items-center justify-center">
            <RichIcon name="library" size={46}/>
          </span>
      ...
      <button type="button" onClick={add}
        ...
        <span className="shrink-0 w-[4.5rem] h-[4.5rem] rounded-2xl bg-[var(--t-surface-2)] flex items-center justify-center">
          <RichIcon name="notebookPen" size={46}/>
        </span>
        <span className="flex-1 text-left min-w-0">
