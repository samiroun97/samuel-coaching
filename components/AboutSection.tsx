      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
        ...
        <div className="relative">
          ...
          <div
            ...
            style={{ backgroundImage: "url('/photos/samuel.jpg')" }}
          >
          ...
          <div className="absolute bottom-8 -right-6 bg-[#c9a84c] px-4 py-3">
            <p className="font-[family-name:var(--font-barlow)] font-black text-2xl text-black">8</p>
        ...
        <div>
          ...
          <h2 className="font-[family-name:var(--font-barlow)] font-black text-[clamp(2.5rem,5vw,4.5rem)] uppercase leading-none text-white mb-8">
            JE SUIS<br />
            <span className="text-[#c9a84c]">SAMUEL</span>
          </h2>
          ...
          <p className="mt-10 font-[family-name:var(--font-barlow)] font-black text-2xl tracking-[0.2em] text-white/10 uppercase select-none">
            Samuel Coaching
          </p>
        </div>
      </div>
